...
import Menu from "@/styles/icons/etc.svg";
        ...
        <header className="w-full flex p-3 ">
            <div className="w-1/2 flex  items-center flex-wrap ">
                ...
                <nav className="w-auto  p-2">
                    ...
                    <Link className="p-2 mx-2 text-gray-300 duration-100 hover:text-white hover:border-b " href={"/pool"}>
                        Pool
                    </Link>
                    <Link className="p-2 mx-2 text-gray-300 duration-100 hover:text-white hover:border-b " href={"/"}>
                        About J$WAP
                    </Link>
                    <Link className="p-2 mx-2 text-gray-300 duration-100 hover:text-white hover:border-b " href={"/vote"}>
                        Vote
                    </Link>
                </nav>
            </div>
